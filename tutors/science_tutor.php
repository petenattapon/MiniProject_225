...
<body>
    <h1>Science Tutors</h1>
    <div class="container mt-5">
        <div class="row row-cols-1 row-cols-md-3 g-4">
            <?php
            $stmt = $conn->query("SELECT * FROM info where urloe = 'user' and tsubject = 'sci'");
            $stmt->execute();
            $users = $stmt->fetchAll();
            ...
            ?>
                    <div class="users col-lg-4">
                        ...
                        <p><button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal<?php echo $user['tid']; ?>">ข้อมูลเพิ่มเติม</button></p>
                    </div>
                    <!-- Modal -->
